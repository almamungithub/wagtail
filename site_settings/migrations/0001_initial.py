# Generated by Django 2.2.7 on 2019-11-24 06:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_contact_name', models.CharField(max_length=100, null=True)),
                ('site_contact_no', models.CharField(max_length=100, null=True)),
                ('site', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, to='wagtailcore.Site')),
            ],
            options={
                'abstract': False,
